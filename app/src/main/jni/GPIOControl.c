...
#include "com_whmnrc_cdy_gpio_GPIOControl.h"
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_whmnrc_cdy_gpio_GPIOControl_exportGpio(JNIEnv *env, jobject instance, jint gpio)
{
 ...
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_whmnrc_cdy_gpio_GPIOControl_setGpioDirection(JNIEnv *env, jobject instance, jint gpio, jint direction)
{
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_whmnrc_cdy_gpio_GPIOControl_readGpioStatus(JNIEnv *env, jobject instance, jint gpio)
{
    char path[DIRECTION_MAX];
    char value_str[3];
    int fd;
 ...
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_whmnrc_cdy_gpio_GPIOControl_writeGpioStatus(JNIEnv *env, jobject instance, jint gpio, jint value)
{
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_whmnrc_cdy_gpio_GPIOControl_unexportGpio(JNIEnv *env, jobject instance, jint gpio)
{
    char buffer[BUFFER_MAX];
    int len;
    int fd;
