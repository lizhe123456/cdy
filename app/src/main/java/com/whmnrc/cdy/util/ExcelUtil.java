        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    RadonBean demoBean = (RadonBean) objList.get(j);
                    List<String> list = new ArrayList<>();
                    list.add(demoBean.getName());
                    list.add(String.valueOf(demoBean.getId()));
                    list.add(String.valueOf(demoBean.getName()));
                    list.add(String.valueOf(demoBean.getRadonValue()));
                    list.add(String.valueOf(demoBean.getCreateTime()));
                    list.add(String.valueOf(demoBean.getDesc()));
                    list.add(String.valueOf(demoBean.getAddress()));
